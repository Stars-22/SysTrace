...
.realtime-cards{display:flex;gap:10px;z-index:1;flex:1;margin-left:24px}
.rt-card{background:var(--bg-card);border:1px solid var(--border);border-radius:12px;padding:10px 14px;display:flex;align-items:center;gap:12px;flex:1;min-width:0;transition:all .25s ease;position:relative;overflow:hidden}
